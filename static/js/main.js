...
// Configs
const modelName = "ConstructionSiteSafetyV3_add_phone.onnx";
...
cv["onRuntimeInitialized"] = async () => {
  ...
  const [yolov8, nms] = await Promise.all([
    ort.InferenceSession.create(`static/model/${modelName}`),
    ort.InferenceSession.create(`static/model/nms-yolov8.onnx`),
  ]);
